...
#define sFLASH_CMD_CE             0xC7  /*!< Bulk Erase instruction */

#define sFLASH_WIP_FLAG           0x01  /*!< Write In Progress spi (WIP) flag */

#define sFLASH_DUMMY_BYTE         0xA5
#define sFLASH_SPI_PAGESIZE       0x100

#define sFLASH_MX25L12835F_ID     0xC22018
...
/**
  ...
  */
#define sFLASH_CS_LOW()       GPIO_WriteBit(sFLASH_CS_GPIO_PORT, sFLASH_CS_PIN,0)
/**
  * @brief  Deselect sFLASH: Chip Select pin high
  */
#define sFLASH_CS_HIGH()      GPIO_WriteBit(sFLASH_CS_GPIO_PORT, sFLASH_CS_PIN,1)   
/**
  * @}
  */ 
